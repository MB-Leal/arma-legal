    ...
    <body>
        ...
        <main class="flex flex-col w-[100vw] items-center min-h-[100vh]">
            ...
            <form method="post" class="w-[90%] mb-4 rounded-md">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="pesquisa" id="default-search"
                        class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500  dark:focus:ring-green-500 dark:focus:border-green-500"
                        placeholder="Pesquisar por Nome" required>
                    <button type="submit"
                        class="text-white absolute right-2.5 bottom-2.5 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 ">Pesquisar</button>
                </div>
            </form>
            ...
            <div class="w-[70%] flex flex-col md:flex-row mb-4 gap-4 justify-center rounded-md text-center ">
                <a href="{{ route('admin.newAssociado') }}"
                    class="p-4 text-white rounded-md text-center border w-full bg-green-700 hover:bg-green-600"
                    type="button">Adicionar Novo Associado
                </a>
                <a href="{{ route('admin.associadoList') }}"
                    class="p-4 text-white rounded-md text-center border w-full bg-green-700 hover:bg-green-600"
                    type="button">Lista geral de associados
                </a>
            </div>

            @if ($resultado != null)
                <div class="overflow-auto shadow-md mr-4 md:mr-0 w-[90%] mt-8 mb-4  justify-center items-center "
                    id="tableLimpa">
                    <table class="text-sm text-left m-auto w-[90%] text-gray-500 items-end justify-center ">
                        <thead class="text-xs text-gray-700 uppercase bg-green-600  ">
                            <tr>
                                ...
                                <th scope="col" class="px-6 text-center py-3 text-white border">
                        ...
                        <tbody>
                            @foreach ($resultado as $res)
                                <tr class="bg-white border-b   hover:bg-gray-50 ">
                                    ...
                                    <td class="px-6 py-4 flex justify-center bg-transparent border text-center">
                                        <a href="{{ route('admin.detalheAssoc', ['id' => $res->id]) }}">
                                            Detalhes
                                        </a>
                                        <a href="{{ route('admin.editarAssoc', ['id' => $res->id]) }}"
                                        ...
                                        <form class="d-inline"
                                            action="{{ route('admin.deletarAssoc', ['id' => $res->id]) }}" method="post"
