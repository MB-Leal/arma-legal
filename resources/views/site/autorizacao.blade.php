...
@section('content')
    <section class="">
        ...
        <form method="post" action="{{ route('site.atualizarAssociado') }}">
            @csrf
            <div class="flex flex-col items-center border flex-wrap p-10 w-[90%] m-auto mb-8" id="formCard">
                ...
                <div class="md:w-[70%] border-b md:pb-4 mb-4 flex flex-col">
                    ...
                    <input type="text" name="arma"
                        class="border-none text-center bg-transparent text-blue-500 md:text-3xl"
                        value="{{ $dados['descArma'] }}" readonly></span>

                    <div class="md:flex md:flex-row justify-center flex-col md:flex-wrap md:w-[100%]">

                        <div class="flex justify-center flex-col items-center md:w-[33%] w-[100%]">
                            <label for="qtd_parcela" class="text-xl font-bold border-none">
                                Parcelas:
                            </label>
                            <input type="text" class="text-xl text-center text-green-500   font-bold bg-transparent border-none" name="qtd_parcela" value="{{ $dados['quantidade'] }}" readonly>
                        </div>

                        <div class="flex justify-center flex-col items-center md:w-[33%] w-[100%]">
                            <label for="valor_parcela" class="text-xl font-bold border-none">
                                Mensal:
                            </label>
                            <input type="text" class="text-xl text-center text-green-500 font-bold bg-transparent border-none" name="valor_parcela" value="{{ $dados['parcela'] }}" readonly>
                        </div>

                        <div class="flex justify-center flex-col items-center md:w-[33%] w-[100%]">
                            <label for="valor_total" class="text-xl  font-bold border-none">
                                Total:
                            </label>
                ...
                <div class="m-auto md:w-[70%] pb-4 mb-4">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div class="w-[100%]">
                            <span>Nome:</span>
                            <input type="text" name="nome" id="nome" class="w-[100%] text-black"
                                value="{{ $associado['nome'] }}">
                        </div>

                        <div class="mb-4 w-[100%]">
                            <span>CPF:</span>
                            <input type="text" class="w-[100%] text-black" name="cpf" value="{{ $associado['cpf'] }}"
                                readonly>
                        </div>
                    ...
                    <div class="flex flex-col mb-4 md:flex-row justify-between gap-4">
                        ...
                        <div class=" w-[100%]">
                            ...
                            <input type="text" class="w-[100%] text-black" name="matricula"
                                value="{{ session()->get('matricula') }}" readonly>
                        </div>

                        <div class=" w-[100%]">
                            <span>Posto/Graduação</span>
                            <select name="posto_graduacao" class="w-[100%] text-black" id="posto_graduacao">
                                <option value="{{ $associado['posto_graduacao'] ? $associado['posto_graduacao'] : '' }}"
                                    selected>
                                    {{ $associado['posto_graduacao'] ? $associado['posto_graduacao'] : 'Selecionar...' }}
                                </option>
                        ...
                        <div class=" w-[100%]">
                            ...
                            <select name="situacao" class="w-[100%] text-black" id="situacao">
                                <option value="{{ $associado['situacao'] ? $associado['situacao'] : '' }}" selected>
                                    {{ $associado['situacao'] ? $associado['situacao'] : 'Selecionar...' }}</option>
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4 mb-4">
                        ...
                        <div class=" w-[100%]">
                            <span>E-mail</span>
                            <input type="email" class="w-[100%] text-black" name="email"
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div class=" w-[100%]">
                            <span>OPM</span>
                            <input type="text" class="w-[100%] text-black" name="opm"
                                value="{{ $associado['opm'] }}" placeholder="Ex: QCG/FASPM" required>
                        </div>

                        <div class=" w-[100%]">
                            <span>Celular</span>
                            <input type="text" class="w-[100%] text-black" name="celular"
                                value="{{ $associado['celular'] }}" placeholder="91900000000">
                        </div>
                ...
                <div class="m-auto md:w-[70%] pb-4 mb-4">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div class="mb-4 w-[100%]">
                            <span>Rua</span>
                            <input type="text" class="w-[100%] text-black" name="rua" id="rua"
                                value="{{ $associado['logradouro'] }}" required>
                        </div>
                    ...
                    <div class="flex flex-col mb-4 md:flex-row justify-between gap-4">
                        ...
                        <div class=" w-[100%]">
                            <span>Cidade</span>
                            <input type="text" class="w-[100%] text-black" name="cidade" id="cidade"
                                value="{{ $associado['municipio'] }}" required>
                        </div>

                        <div class=" w-[100%]">
                            <span>Bairro</span>
                            <input type="text" class="w-[100%] text-black" name="bairro" id="bairro"
                                value="{{ $associado['bairro'] }}" required>
                        </div>

                        <div class=" w-[100%]">
                            <span>UF</span>
                            <input type="text" class="w-[100%] text-black" name="uf" id="uf"
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4 mb-4">
                        ...
                        <div class=" w-[100%]">
                            ...
                            <input type="text" class="w-[100%] text-black" name="complemento" id="complemento"
                                value="{{ $associado['complemento'] }}">
                        </div>

                        <div class=" w-[100%]">
                            <span>Número</span>
                            <input type="text" class="w-[100%] text-black" name="numero" id="numero"
