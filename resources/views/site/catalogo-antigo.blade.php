...
@section('content')
    ...
    <div id="loading" class="loading-overlay">
        <div class="loading-spinner">
            <img src={{ asset('./Imgs/gun-loading.png') }} alt="">
        </div>

    </div>

    <div
        class="bg-transparente absolute top-4 left-4 p-2 overflow-hidden rounded-md border-white bg-red-600 text-white border">
        <i class="fa-sharp fa-solid fa-delete-left"></i>
        <a href="{{ route('site.logout') }}"><button>Sair</button></a>
    </div>
    @while ($pistolaTaurus == '')
    <h1>Teste de Loading</h1>
    @endwhile
    ...
    <main class="flex lg:flex-row flex-col h-[100vh] overflow-auto " id="logo-catalogo">
        ...
        <div class="lg:w-[80%] lg:h-[100vh] justify-start lg:overflow-auto ">
            ...
            <div id="alert-border-3"
                class="flex p-4 mb-4 text-green-800 mt-4 w-[90%] m-auto border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800"
                role="alert">
                ...
                <div class="ml-3 text-sm font-medium">
                    IMPORTANTE: Verificar em seu contra-cheque se possui <strong>SALDO CONSIGNÁVEL</strong> suficiente para
                    aquisição.
                </div>
                <button type="button"
            ...
            <div id="alert-border-2"
                ...
                <div class="ml-3 text-sm font-medium">
                    IMPORTANTE: Exclusivo para associado do FASPM que já foi lançado o primeiro desconto em seu
                    contra-cheque.
                </div>
                <button type="button"
            ...
            <div id="alert-border-1"
                class="flex p-4 mb-4 text-purple-800 mt-4 w-[90%] m-auto border-t-4 border-purple-300 bg-purple-50 dark:text-purple-400 dark:bg-gray-800 dark:border-purple-800"
                role="alert">
                <svg class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                ...
                <div class="ml-3 text-sm font-medium">
                    <a href="/Imgs/etapas.png" download><u>CLIQUE AQUI</u></a> para baixar o passo a passo do Processo de
                    Financiamento do FASPM.
                </div>
                <button type="button"
                    class="ml-auto -mx-1.5 -my-1.5 bg-purple-50 text-purple-500 rounded-lg focus:ring-2 focus:ring-purple-400 p-1.5 hover:bg-purple-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-purple-400 dark:hover:bg-gray-700"
            ...
            <div class="w-[70%] m-auto mt-4">
                ...
                <div
                    class="max-w-sm bg-white m-auto border border-gray-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-5">
                        <h5
                            class="mb-4 text-2xl border-b-2 font-bold tracking-tight text-center text-amber-500 dark:text-white">
                            BONUS EXCLUSIVO !!!
                        </h5>
                        ...
                        <p class="mb-3 text-center font-normal text-gray-700 dark:text-gray-400">Na compra de qualquer
                            <strong>arma curta</strong>, você ganha <strong>COLDRE + 1 BLISTER DE MUNIÇÃO</strong>.
                        </p>
                    </div>
                </div>
                            ...
                            @foreach ($pistolaTaurus as $pistolaT)
                                ...
                                <div
                                    ...
                                    <div class="mb-4 w-[15em] h-[50%] flex flex-wrap">
                                        <img class="rounded-md bg-white" src="{{ $pistolaT->img1 }}"
                                            alt="pistola taurus">
                                    </div>
                                    <!-- Corpo do card -->
                                    <div
                                        ...
                                        <p>{{ $pistolaT->nome }}</p>
                                        <span id="calibre">Calibre: {{ $pistolaT->calibre }}</span>
                                        ...
                                        @if ($pistolaT->quantidade <= $pistolaT->estoque_min)
                                            ...
                                            <a href="{{ url($link) }}">
                                                <button type="button"
                                                    class="font-semibold rounded-md animate-pulse mt-2 mb-2 p-2 texxt-red bg-red-700">Poucas
                                                    unidades deste produto. <br> Consulte via Whatsapp
                                                    aqui!</button>
                                            </a>
                                        @endif
                                        ...
                                        <a class="block text-white bg-gray-900  hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            href="{{ route('site.detalhe', ['id' => $pistolaT->id]) }}">
                                            <button type="button">
                                                Mais detalhes
                                            </button>
                                        </a>
                        ...
                        <div class="grid xl:grid-cols-3 lg:grid-cols-2 gap-8 m-auto">
                            @foreach ($revolverTaurus as $revolverT)
                                ...
                                <div
                                    ...
                                    <!-- Img da arma -->
                                    <div class="mb-4 w-[15em] h-[50%] flex flex-wrap">
                                        <img class="rounded-md bg-white" src="{{ $revolverT->img1 }}"
                                            alt="pistola taurus">
                                    </div>
                                    <!-- Corpo do card -->
                                    <div
                                        ...
                                        <!-- Botão de detalhe -->
                                        <a class="block text-white bg-gray-900  hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            href="{{ route('site.detalhe', ['id' => $revolverT->id]) }}">
                                            <button type="button">
                                                Mais detalhes
                                            </button> </a>
                        ...
                        <div class="grid xl:grid-cols-3 lg:grid-cols-2 gap-8 m-auto">
                            @foreach ($longasCBC as $longasC)
                                ...
                                <div
                                    ...
                                    <!-- Img da arma -->
                                    <div class="mb-4 w-[15em] h-[50%] flex flex-wrap">
                                        <img class="rounded-md bg-white" src="{{ $longasC->img1 }}"
                                            alt="pistola taurus">
                                    </div>
                                    <!-- Corpo do card -->
                                    <div
                                        ...
                                        <!-- Botão de detalhe -->
                                        <a class="block text-white bg-gray-900  hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            href="{{ route('site.detalhe', ['id' => $longasC->id]) }}">
                                            <button type="button">
                                                Mais detalhes
                                            </button>
                                        </a>
                        ...
                        <div class="grid xl:grid-cols-3 lg:grid-cols-2 gap-8 m-auto">
                            @foreach ($pistolaGlock as $pistolaG)
                                ...
                                <div
                                    ...
                                    <!-- Img da arma -->
                                    <div class="mb-4 w-[15em] h-[50%] flex flex-wrap">
                                        <img class="rounded-md bg-white" src="{{ $pistolaG->img1 }}"
                                            alt="pistola taurus">
                                    </div>
                                    <!-- Corpo do card -->
                                    <div
                                        ...
                                        <a class="block text-white border bg-gray-900  hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            href="{{ route('site.detalhe', ['id' => $pistolaG->id]) }}">
                                            <button type="button">
                                                Mais detalhes
                                            </button>
                                        </a>
    ...
    <script defer>/*
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const controle = document.getElementById('calibre');

            // Mostrar o loading
            //loadingOverlay.style.display = 'block';

            // Ocultar o loading após 5 segundos
            while (controle.value == '') {
                loadingOverlay.style.display = 'block';
                }
                /*
            setTimeout(function() {
                loadingOverlay.style.display = 'none';
            }, 9000); // 5000 milissegundos = 5 segundos */
        }); */
    </script>
@endsection
